			...
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					<div class="comt-tips"><?php comment_id_fields(); do_action('comment_form', $post->ID); ?></div>
					 <button type="submit" name="submit" id="submit" tabindex="5"><?php echo _hui('comment_submit_text') ? _hui('comment_submit_text') : '提交评论' ?>
				 </button>
				 <input type="button" class="qk" id="qk" value="重新编辑" onclick="document.getElementById('comment').value = ''" />
				 <br/><br/>
<div class="zz-add-img"><input id="zz-img-file" type="file" accept="image/*" multiple="multiple"><div id="zz-img-add">图片</div><div id="zz-img-show"></div></div>
...
<div id="ajaxloading"></div>
							<li class="form-inline"><label class="hide" for="qq">QQ账号</label><input class="ipt" type="text" name="qq" id="qq" value="" tabindex="2" placeholder="输入QQ号自动填写信息！"><span class="text-muted">快速填写</span></li>
							...
							<li class="form-inline"><label class="hide" for="url">网址</label><input class="ipt" type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" tabindex="4" placeholder="网址"><span class="text-muted">网址（选填）</span></li>
						</ul>
					</div>
				<?php } ?>
			<?php } ?>
